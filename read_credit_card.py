...
def ctpn(sess, net, img,image_name):
    global detect_graph
    timer = Timer()
    timer.tic()
...
if __name__ == '__main__':
    ...
    im_name = args["image"]
    print("Image path:",im_name)

    ##### Preprocess Image

    scanner = DocScanner()

    sharp_im, thresh_im = scanner.scan(im_name)
    ...
    with detect_graph.as_default():
        ...
        boxes,img,scale = ctpn(sess, net, img2,im_name)
    ...
    for box in boxes:
        ...
        save_name = "data/text_read/" + info_type + "_" + base_name
